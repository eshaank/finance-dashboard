...
NASDAQ100_TICKERS: frozenset[str] = frozenset({
    "AAPL", "ABNB", "ADBE", "ADI", "ADP", "ADSK", "AEP", "AMAT", "AMD",
    "AMGN", "AMZN", "ANSS", "ARM", "ASML", "AVGO", "AZN", "BIIB", "BKNG",
    "BKR", "CDNS", "CDW", "CEG", "CHTR", "CMCSA", "COST", "CPRT", "CRWD",
    "CSCO", "CSGP", "CTAS", "CTSH", "DASH", "DDOG", "DLTR", "DXCM", "EA",
    ...
    "RIVN", "ROST", "SBUX", "SIRI", "SNPS", "SPLK", "TEAM", "TMUS", "TSLA",
    "TTD", "TTWO", "TXN", "VRSK", "VRTX", "WBA", "WDAY", "XEL", "ZS",
})


def get_constituents(preset: str) -> frozenset[str] | None:
    """Return ticker set for a preset, or None for 'all'."""
    if preset == "spy500":
