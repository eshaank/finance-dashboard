---
description: Reviews code changes for security vulnerabilities, performance issues, type safety, and best practices.
tools:
  write: false
  edit: false
---

<!-- Source of truth: .rules/agents/code-reviewer.md — keep in sync -->
